...
public class PrintCalendar {
    public static void main(String[] args){
        ...
        System.out.println("Enter a number as year ,such as 2022:");
        int year=input.nextInt();
        System.out.println("Enter a number as month ,such as 12:");
    ...
    public static void printMonthBody(int year,int month){
        ...
        int numberOfDaysInMonth=getNumberOfDaysMonth(year,month);
        int i=0;
